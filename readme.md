...
* [X] List anything else that you can get done to improve the app functionality!
        Landscape implemented for activity page

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/michfeng/Flixter/blob/main/readme2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
